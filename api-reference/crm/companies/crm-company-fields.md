...
|| **HAS_EMAIL**
[`boolean`](../../data-types.md) | Проверка заполненности поля электронной почты | Только для чтения ||
|| **HAS_PHONE**
[`boolean`](../../data-types.md) | Проверка заполненности поля телефона | Только для чтения ||
|| **ID**
...
|| **OPENED**
[`boolean`](../../data-types.md) | Доступен для всех | ||
|| **ORIGINATOR_ID**
